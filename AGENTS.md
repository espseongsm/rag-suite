...
- the entry point is the main.py script. The main.py should be clean and easy to understand the project, modulizing the features.
...
- Update prd.md and daily-development-report.md.
